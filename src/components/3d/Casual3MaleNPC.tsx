...
export const Casual3MaleNPC = ({ 
  colorTint, 
  startPosition, 
  roleName = "Casual3 Male",
  maxWanderRadius,
  dialogId
}: Casual3MaleNPCProps) => {
  const { scene, animations } = useGLTF('./models/NPCs/Casual3_Male.glb');
  ...
  return (
    <group ref={containerRef} scale={0.58}>
      ...
      {/* Debug Name Tag */}
      <DistanceNameTag name="Casual3_Male" />
