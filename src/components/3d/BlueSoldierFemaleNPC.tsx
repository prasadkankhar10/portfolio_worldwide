...
interface BlueSoldierFemaleNPCProps {
  colorTint?: string;
  roleName?: string;
...
export const BlueSoldierFemaleNPC = ({ 
  colorTint, 
  startPosition, 
  roleName = "BlueSoldier Female",
  maxWanderRadius,
  dialogId
}: BlueSoldierFemaleNPCProps) => {
  const { scene, animations } = useGLTF('./models/NPCs/BlueSoldier_Female.glb');
  ...
  return (
    <group ref={containerRef} scale={0.58}>
      ...
      {/* Debug Name Tag */}
      <DistanceNameTag name="BlueSoldier_Female" />
