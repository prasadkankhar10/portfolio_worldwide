...
export const KnightMaleNPC = ({ 
  colorTint, 
  startPosition, 
  roleName = "Knight Male",
  maxWanderRadius,
  dialogId
,
  startState = "THINKING",
  ...
  useNpcRegistry(npcId, 'KNIGHT_BLUE', containerRef, stateRef, 'DUEL');
  ...
  return (
    <group ref={containerRef} scale={0.58}>
      ...
      {/* Debug Name Tag */}
      <DistanceNameTag name="Knight_Male" />
