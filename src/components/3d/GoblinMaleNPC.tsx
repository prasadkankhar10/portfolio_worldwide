...
export const GoblinMaleNPC = ({ 
  colorTint, 
  startPosition, 
  roleName = "Goblin Male",
  maxWanderRadius,
  dialogId
}: GoblinMaleNPCProps) => {
  const { scene, animations } = useGLTF('./models/NPCs/Goblin_Male.glb');
  ...
  return (
    <group ref={containerRef} scale={0.58}>
      ...
      {/* Debug Name Tag */}
      <DistanceNameTag name="Goblin_Male" />
